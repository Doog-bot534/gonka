...
var (
	...
	TransientEpochDataCacheKey        = collections.NewPrefix(4)
	TransientEpochDataCacheEpochKey   = collections.NewPrefix(5)
	TransientEpochDataModelMetaKey    = collections.NewPrefix(6)
	TransientEpochDataModelWeightKey  = collections.NewPrefix(7)
)
