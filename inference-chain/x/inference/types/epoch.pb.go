...
func (*Epoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_c4155d4ad4931767, []int{0}
}
...
func (m *Epoch) GetPocStartBlockHeight() int64 {
	if m != nil {
...
func (m *Epoch) GetDescription() string {
	if m != nil {
...
func init() {
	proto.RegisterType((*Epoch)(nil), "inference.inference.Epoch")
}

func init() { proto.RegisterFile("inference/inference/epoch.proto", fileDescriptor_c4155d4ad4931767) }

var fileDescriptor_c4155d4ad4931767 = []byte{
	// 216 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Epoch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Description) > 0 {
		...
		i = encodeVarintEpoch(dAtA, i, uint64(len(m.Description)))
		i--
		dAtA[i] = 0x1a
	}
	if m.PocStartBlockHeight != 0 {
		i = encodeVarintEpoch(dAtA, i, uint64(m.PocStartBlockHeight))
		i--
		dAtA[i] = 0x10
	}
	if m.Index != 0 {
		i = encodeVarintEpoch(dAtA, i, uint64(m.Index))
		i--
		dAtA[i] = 0x8
	}
...
func (m *Epoch) Size() (n int) {
	...
	_ = l
	if m.Index != 0 {
		n += 1 + sovEpoch(uint64(m.Index))
	}
	if m.PocStartBlockHeight != 0 {
		n += 1 + sovEpoch(uint64(m.PocStartBlockHeight))
	}
	l = len(m.Description)
	if l > 0 {
