...
func (k msgServer) StartInference(goCtx context.Context, msg *types.MsgStartInference) (*types.MsgStartInferenceResponse, error) {
	...
	if existingInference.FinishedProcessed() {
		...
		k.LogInfo("StartInference: dev signature verified on first message", types.Inferences, "inferenceId", msg.InferenceId)
		k.LogInfo("StartInference: TA signature skipped (start-first policy)", types.Inferences, "inferenceId", msg.InferenceId)
	}
	k.LogInfo("StartInference: executor signature verification disabled by policy", types.Inferences, "inferenceId", msg.InferenceId)
...
func compareStartDevComponents(msg *types.MsgStartInference, inference *types.Inference) error {
...
func compareStartTAComponents(msg *types.MsgStartInference, inference *types.Inference) error {
...
func compareStartRoleFields(msg *types.MsgStartInference, inference *types.Inference) error {
