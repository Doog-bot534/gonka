...
var (
	...
	fd_Epoch_description            protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Epoch_description = md_Epoch.Fields().ByName("description")
}
...
func (x *fastReflection_Epoch) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Description != "" {
		...
		if !f(fd_Epoch_description, value) {
			return
		}
	}
}
...
func (x *fastReflection_Epoch) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.Epoch.description":
...
func (x *fastReflection_Epoch) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.Epoch.description":
		panic(fmt.Errorf("field description of message inference.inference.Epoch is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.Epoch"))
		}
...
func (x *Epoch) GetDescription() string {
	if x != nil {
		return x.Description
	}
	return ""
...
var file_inference_inference_epoch_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x22, 0x74, 0x0a, 0x05, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x12,
	...
	0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0xb8, 0x01, 0x0a,
	0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69,
	0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x0a, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x50,
