...
var (
	...
	fd_PoCValidationSnapshot_model_id                   protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_PoCValidationSnapshot_model_id = md_PoCValidationSnapshot.Fields().ByName("model_id")
}
...
func (x *fastReflection_PoCValidationSnapshot) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ModelId != "" {
		...
		if !f(fd_PoCValidationSnapshot_model_id, value) {
			return
		}
	}
}
...
func (x *fastReflection_PoCValidationSnapshot) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "inference.inference.PoCValidationSnapshot.model_id":
		return x.ModelId != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_PoCValidationSnapshot) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "inference.inference.PoCValidationSnapshot.model_id":
		panic(fmt.Errorf("field model_id of message inference.inference.PoCValidationSnapshot is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: inference.inference.PoCValidationSnapshot"))
		}
...
func (x *PoCValidationSnapshot) GetModelId() string {
	if x != nil {
		return x.ModelId
	}
	return ""
...
var file_inference_inference_poc_validation_snapshot_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x22, 0xf2, 0x02, 0x0a, 0x15, 0x50, 0x6f, 0x43,
	...
	0x6d, 0x70, 0x12, 0x19, 0x0a, 0x08, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x49, 0x64, 0x22, 0x43, 0x0a,
	0x0f, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x57, 0x65, 0x69, 0x67, 0x68, 0x74,
	...
	0x68, 0x74, 0x42, 0xc8, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72,
	0x65, 0x6e, 0x63, 0x65, 0x2e, 0x69, 0x6e, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x1a,
	0x50, 0x6f, 0x63, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x6e, 0x61,
	0x70, 0x73, 0x68, 0x6f, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x24, 0x63, 0x6f,
