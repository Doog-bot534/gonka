...
func (c *queryClient) PoCObservations(ctx context.Context, in *QueryPoCObservationsRequest, opts ...grpc.CallOption) (*QueryPoCObservationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_PoCObservations_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PoCConsensus(ctx context.Context, in *QueryPoCConsensusRequest, opts ...grpc.CallOption) (*QueryPoCConsensusResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_PoCConsensus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) PoCObservations(context.Context, *QueryPoCObservationsRequest) (*QueryPoCObservationsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PoCObservations not implemented")
}
func (UnimplementedQueryServer) PoCConsensus(context.Context, *QueryPoCConsensusRequest) (*QueryPoCConsensusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PoCConsensus not implemented")
}
