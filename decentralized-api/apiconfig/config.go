...
type PocPropagationConfig struct {
	...
	RetainAllProofs bool   `koanf:"retain_all_proofs" json:"retain_all_proofs"` // If true, proofs are never deleted; if false, proofs from epoch N-2 are deleted when epoch N starts
}
