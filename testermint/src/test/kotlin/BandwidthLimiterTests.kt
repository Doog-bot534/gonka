...
class BandwidthLimiterTests : TestermintTest() {
    ...
    fun `bandwidth limiter with rate limiting`() {
        ...
        assertThat(bandwidthRejectionCount).describedAs("Bandwidth limiter should reject many requests with 30 parallel requests (~15MB total vs 512KB limit)").isGreaterThanOrEqualTo(8)
